...
def tab3_home():
    page_config = {
        "main_heading": "Road out the trenches",             # Main heading text
        ...
        "paragraphs": "This is prophecy.",         # Main paragraph text
        ...
        "background_image": "/static/media/trench_back.jpeg" # Background image URL for the page
    }
